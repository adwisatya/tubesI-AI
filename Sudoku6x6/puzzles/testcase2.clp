...
(defrule grid-values
   ...
   (assert (possible (row 1) (column 2) (value 2) (group 1) (id 2) (diagonal 3)))
   ...
   (assert (possible (row 1) (column 5) (value 5) (group 2) (id 8) (diagonal 3)))
   (assert (possible (row 1) (column 6) (value any) (group 2) (id 9) (diagonal 2)))
   (assert (possible (row 2) (column 4) (value 2) (group 2) (id 10) (diagonal 3)))
   ...
   (assert (possible (row 3) (column 3) (value 1) (group 3) (id 15) (diagonal 1))) 
   ...
   (assert (possible (row 4) (column 6) (value 3) (group 4) (id 24) (diagonal 3)))   
   ...
   (assert (possible (row 5) (column 3) (value 3) (group 5) (id 27) (diagonal 3))) 
   (assert (possible (row 6) (column 1) (value 6) (group 5) (id 28) (diagonal 2)))
   ...
   (assert (possible (row 6) (column 5) (value 4) (group 6) (id 35) (diagonal 3)))
